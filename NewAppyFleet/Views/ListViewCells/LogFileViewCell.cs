...
{
    public class LogFileViewCell : ViewCell
    {
        public LogFileViewCell()
        {
            var grid = new Grid
            {
            ...
            lblFile.SetBinding(Label.TextProperty, new Binding("AppArea"));

            var btnSend = new Button
            {
                Text = Langs.Const_Button_Send,
                TextColor = Color.White,
                FontFamily = Helper.RegFont,
            ...
            btnSend.SetBinding(Button.ClassIdProperty, new Binding("DateId"));
            btnSend.Command = new Command(() => MessagingCenter.Send<LogFileViewCell, string>(this, "logfile", btnSend.ClassId));
